    ...
    <main className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-purple-900 text-white p-8 flex flex-col items-center">
      ...
      <section className="text-center max-w-3xl">
        ...
        <p className="text-lg text-gray-300 mb-12">
          Our Structured Learning Path Takes You From Web3 Basics To Advanced
          Trading Strategies.
        </p>
      </section>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
        <div className="bg-gray-800 p-6 rounded-2xl shadow-lg text-center hover:bg-gray-700 transition">
          ...
          <p className="text-gray-400 text-sm">
            Accreditation and Trading Results Are Verified On-Chain, Enabling
        ...
        <div className="bg-gray-800 p-6 rounded-2xl shadow-lg text-center hover:bg-gray-700 transition">
          ...
          <p className="text-gray-400 text-sm">
            Live Trading Battles Have Results Tracked On-Chain, Ensuring
        ...
        <div className="bg-gray-800 p-6 rounded-2xl shadow-lg text-center hover:bg-gray-700 transition">
          ...
          <p className="text-gray-400 text-sm">
            Accreditations And Achievements Are Verified And Secured Through NFT
            Certifications.
          </p>
        </div>
      </section>
      ...
      <section className="flex flex-col md:flex-row items-center gap-10 max-w-6xl">
        ...
        <div className="flex-1 text-center md:text-left">
          <h2 className="text-3xl font-bold mb-4">
            Prove Your <span className="text-purple-400">Skills</span> On-Chain
          </h2>
          <p className="text-gray-300 mb-6">
            Our Tournaments And Accreditations Are Powered By On-Chain
            Verification To Ensure True Transparency And Meritocracy.
          </p>
