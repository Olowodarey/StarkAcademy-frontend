    ...
    <section className="relative py-32 overflow-hidden bg-gradient-to-b from-gray-900 to-black">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="relative">
          ...
          <div className="space-y-24">
            ...
            <div className="relative flex flex-col lg:flex-row items-center gap-12">
              <div className="lg:w-1/2 lg:pr-16 space-y-6 order-2 lg:order-1">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 text-xs bg-purple-500/20 text-purple-300 rounded-full border border-purple-500/30">Interactive Lessons</span>
              ...
              <div className="lg:w-1/2 lg:pl-16 order-1 lg:order-2">
                <div className="relative group">
                  ...
                  <Card className="relative bg-gradient-to-br from-gray-900/90 to-gray-800/90 backdrop-blur-xl border border-gray-700/50 p-8">
                    <CardContent className="p-0 space-y-6">
                      ...
                      <div className="text-sm text-gray-400">Module 1: Technical Analysis Basics</div>
                    </CardContent>
                  </Card>
                </div>
              </div>
            ...
            <div className="relative flex flex-col lg:flex-row items-center gap-12">
              <div className="lg:w-1/2 lg:pl-16 space-y-6 order-2">
                <div className="flex items-center space-x-4">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-white">Compete</h3>
                </div>
                <h4 className="text-xl md:text-2xl font-semibold bg-gradient-to-r from-pink-400 to-red-400 bg-clip-text text-transparent">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 text-xs bg-red-500/20 text-red-300 rounded-full border border-red-500/30">Live Competitions</span>
                  <span className="px-3 py-1 text-xs bg-orange-500/20 text-orange-300 rounded-full border border-orange-500/30">Global Leaderboards</span>
                  <span className="px-3 py-1 text-xs bg-yellow-500/20 text-yellow-300 rounded-full border border-yellow-500/30">Real-time Trading</span>
                </div>
              </div>
                    ...
                    <CardContent className="p-0 space-y-6">
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between items-center">
                          <span className="text-white font-semibold">Weekly Tournament</span>
                          <span className="px-2 py-1 text-xs bg-green-500/20 text-green-300 rounded-full border border-green-500/30">Live</span>
                        </div>
            ...
            <div className="relative flex flex-col lg:flex-row items-center gap-12">
              <div className="lg:w-1/2 lg:pr-16 space-y-6 order-2 lg:order-1">
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-yellow-600 to-orange-600 rounded-full flex items-center justify-center text-white font-bold text-xl">
                    3
                  </div>
                  <h3 className="text-2xl md:text-3xl font-bold text-white">Earn</h3>
                </div>
                <h4 className="text-xl md:text-2xl font-semibold bg-gradient-to-r from-yellow-400 to-orange-400 bg-clip-text text-transparent">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 text-xs bg-yellow-500/20 text-yellow-300 rounded-full border border-yellow-500/30">Prize Pools</span>
                  <span className="px-3 py-1 text-xs bg-orange-500/20 text-orange-300 rounded-full border border-orange-500/30">Token Airdrops</span>
                  <span className="px-3 py-1 text-xs bg-amber-500/20 text-amber-300 rounded-full border border-amber-500/30">Exclusive Badges</span>
                </div>
              </div>
              <div className="lg:w-1/2 lg:pl-16 order-1 lg:order-2">
                <div className="relative group">
                    ...
                    <CardContent className="p-0 space-y-6">
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        <div className="text-center space-y-2">
                          ...
                          <div className="text-xs text-gray-400">Gold Badge</div>
                        </div>
                        <div className="text-center space-y-2">
                          <div className="w-12 h-12 bg-gradient-to-r from-green-500 to-emerald-500 rounded-lg mx-auto"></div>
                          <div className="text-xs text-gray-400">$500 Prize</div>
                        </div>
                        <div className="text-center space-y-2">
            ...
            <div className="relative flex flex-col lg:flex-row items-center gap-12">
              <div className="lg:w-1/2 lg:pl-16 space-y-6 order-2">
                <div className="flex items-center space-x-4">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-white">Certify</h3>
                </div>
                <h4 className="text-xl md:text-2xl font-semibold bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 text-xs bg-green-500/20 text-green-300 rounded-full border border-green-500/30">NFT Certificates</span>
                  <span className="px-3 py-1 text-xs bg-emerald-500/20 text-emerald-300 rounded-full border border-emerald-500/30">On-Chain Proof</span>
                  <span className="px-3 py-1 text-xs bg-teal-500/20 text-teal-300 rounded-full border border-teal-500/30">Permanent Record</span>
                </div>
              </div>
              <div className="lg:w-1/2 lg:pr-16 order-1">
                <div className="relative group">
                    ...
                    <CardContent className="p-0 space-y-6">
                      ...
                      <div className="space-y-4">
                        <div className="text-center">
                          ...
                          <h5 className="text-white font-semibold">Advanced Trader Certificate</h5>
                          <p className="text-gray-400 text-sm">Verified on StarkNet</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
            ...
            <div className="relative flex flex-col lg:flex-row items-center gap-12">
              <div className="lg:w-1/2 lg:pr-16 space-y-6 order-2 lg:order-1">
                <div className="flex items-center space-x-4">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-white">Teach</h3>
                </div>
                <h4 className="text-xl md:text-2xl font-semibold bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1 text-xs bg-blue-500/20 text-blue-300 rounded-full border border-blue-500/30">Tutor Status</span>
                  <span className="px-3 py-1 text-xs bg-indigo-500/20 text-indigo-300 rounded-full border border-indigo-500/30">Passive Income</span>
                  <span className="px-3 py-1 text-xs bg-purple-500/20 text-purple-300 rounded-full border border-purple-500/30">Mentorship</span>
                </div>
              </div>
              <div className="lg:w-1/2 lg:pl-16 order-1 lg:order-2">
                <div className="relative group">
                    ...
                    <CardContent className="p-0 space-y-6">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <span className="text-white font-semibold">Monthly Earnings</span>
        ...
        <div className="text-center mt-20 space-y-8">
          <div className="space-y-4">
            <h3 className="text-3xl font-bold text-white">Ready to Start Your Journey?</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-8 py-4 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 hover:from-purple-700 hover:via-pink-700 hover:to-blue-700 text-white rounded-full text-lg font-semibold transition-all duration-300 transform hover:scale-105">
              Begin Your Journey
            </button>
            <button className="px-8 py-4 border border-purple-500 text-purple-400 hover:bg-purple-500/10 bg-transparent rounded-full text-lg font-semibold transition-all duration-300">
              Watch Demo
            </button>
          </div>
        </div>
